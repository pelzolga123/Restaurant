...
const about = () => {
  ...
  addImg('https://pelzolga123.github.io/Restaurant/img/about-croissant.jpg', 'croissantSection', 'croissant');
  addImg('https://pelzolga123.github.io/Restaurant/img/line_2.png', 'croissantSection', 'croissant_line');
  ...
  addImg('https://pelzolga123.github.io/Restaurant/img/line_2.png', 'macaroonSection', 'macaroon_line');
  addImg('https://pelzolga123.github.io/Restaurant/img/about-macaroon.jpg', 'macaroonSection', 'macaroon');
  addImg('https://pelzolga123.github.io/Restaurant/img/about-donut.jpg', 'donutSection', 'donut');
  addImg('https://pelzolga123.github.io/Restaurant/img/line_2.png', 'donutSection', 'donut_line');
